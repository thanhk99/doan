...
public class betHisfbxsController {
            ...
            for (betHisfbxs bet : betsToSettle) {
                ...
                for (JsonNode match : matches) {
                    ...
                    if (bet.getReferenceId().equals(matchId)) {
                        ...
                        System.out.println(
                                "Tìm thấy trận tương ứng: " + homeTeam + " vs " + awayTeam + " - Status: " + status);
                        ...
                        System.out.println("Kết quả trận đấu: " + actualResult + " | Dự đoán của người chơi: "
                                + bet.getPrediction());
    ...
    public ResponseEntity<?> settleLotteryBets() {
        try {
            ...
            if (bets.isEmpty())
                return ResponseEntity.ok("Không có cược nào cần xử lý.");
